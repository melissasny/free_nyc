class EventsController < ApplicationController
  ...
  def shared_content
    ...
    @notes = ["  ", 
      ...
      "Books at Noon events are standing room only.",
      ...
      "Doors open at 6:30.",
      "Gates open at 3 pm.",
      "Free tickets available in advance at the box office, see event website.",
      ...
      "Seating begins at 6:30, movie begins at dusk.",
      "At the Elinor Bunin Munroe Film Center.",
      "Suggested admission of $5.",
      "Admission is pay as you wish.",
      "Free with pay as you wish museum admission.",
      "RSVP recommended - see event website. Free with pay as you wish museum admission.",
      ...
      "Admission is pay as you wish from 3-3:30 pm. The aquarium closes at 4:30.",
      ...
      "Doors open at 6; credit card or id required to borrow free headphones; no bags on the dance floor.",
      "Doors open at 1; credit card or id required to borrow free headphones; no bags on the dance floor.",
      "Jerome Ave entrance @ Jerome and Bainbridge; doors open at 4; credit card or id required to borrow free headphones; no bags on the dance floor.",
